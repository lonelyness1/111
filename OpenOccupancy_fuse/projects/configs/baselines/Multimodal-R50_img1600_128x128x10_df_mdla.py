...
work_dir = f"/share/lisy/OpenOccupancy/work_dirs/ve/Multimodal-R50_img1600_128x128x10_df_mdla_{TIMESTAMP}"
# resume_from = "/share/lisy/OpenOccupancy/work_dirs/ve/Multimodal-R50_img1600_128x128x10_deepfusenz_2023-11-07_02-18/epoch_4.pth"
...
model = dict(
    ...
    img_neck=dict(
        ...
        out_channels=[numC_Trans//4, numC_Trans//4, numC_Trans//4, numC_Trans//4]),
    ...
    pts_pillar_layer=dict(
        max_num_points=20, 
        point_cloud_range=point_cloud_range,
        voxel_size=pillar_size,  # xy size follow centerpoint
        max_voxels=(90000, 180000)),
    pts_voxel_encoder=dict(type='HardSimpleVFE', num_features=5),
    pts_middle_encoder=dict(
        type='SparseLiDAREnc8x',
        input_channel=4,
        base_channel=16,
        out_channel=numC_Trans,  # same with img feat
        norm_cfg=dict(type='SyncBN', requires_grad=True),
